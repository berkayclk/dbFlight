...
/** İÇERİSİNDE 3 ADET İŞLEM YAPILMIŞTIR. YORUM SATIRI İLE YAPILAN İŞLEMLER BAŞLIK OLARAK EKLENDİ */
       ...
       BEGIN
		   ...
		   set @currentLegNumber = @lastLegNumber +1
			...
			INSERT INTO FLIGHT_LEG (Flight_number,Leg_number,Departure_airport_code,Scheduled_departure_time,Arrival_airport_code,Scheduled_arrival_time)
			 select Flight_number,@currentLegNumber,Departure_airport_code,Scheduled_departure_time,Arrival_airport_code,Scheduled_arrival_time 
			 from inserted
