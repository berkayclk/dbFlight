...
select a.Airplane_id as "AIRPLANE ID"  , (ap.Company + ' ' + a.Airplane_type ) as "AIRPLANE NAME", a.Total_number_of_seats as "SEAT COUNT" 
FROM AIRPLANE a , AIRPLANE_TYPE ap
where a.Airplane_type = ap.Airplane_type_name and
